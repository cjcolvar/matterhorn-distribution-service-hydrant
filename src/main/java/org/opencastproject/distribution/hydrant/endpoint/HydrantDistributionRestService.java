 ...
 *
 */
package org.opencastproject.distribution.hydrant.endpoint;
...
/**
 * Rest endpoint for distributing media to the local hydrant distribution channel.
 */
@Path("/")
...
public class HydrantDistributionRestService extends AbstractJobProducerEndpoint {

  /** The logger */
  private static final Logger logger = LoggerFactory.getLogger(HydrantDistributionRestService.class);
